...
public class Register{
     ...
     * @throws IOExceptionFileWriter fw = new FileWriter(fi
     * @throws true);fw.write(id);fw.close();}public static String[] readFile(String file)Scanner sc = new Scanner(System.in);try
     */
    public static String[] readFiles(String file){// converting the data of the file into array and storing the appended data into files
        try{
            ...
            /**
             * Making sure if the user exist or not 
             * If user already exists the flag=0 goes back to the main menu
             * If not ten the account will be creates
             */
            if(flag==1){//if repeats then user already exists
                ...
                /**
                 * If the user is new then goes to this method String[] data1=readFile("password.txt")
                 */
    ...
    public static String[] readFile(String file){//converting the data of file into the array and storing the appended data into files
        try{
            ...
            /**
             * Entering the password and appending according to it 
             * And finally Account will be created
             */
