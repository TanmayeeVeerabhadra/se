...
public class ReturnBook {
    ...
    public static String readers(String filename) throws IOException {
    ...
    public static void writes(String id, File fi) throws IOException {// creating a method to write the data to file
                ...
                if (bname.equals(arr[i])) {// here it compares the input bookname with the available books
                    ...
                    if (ch.equals("y")) {
                        ...
                        if(ro.length()==10){
                            ...
                            File fi = new File("C:\\Users\\USER\\Desktop\\tanmayee\\returnreport.txt");
                            try {
                                writes("The book " + bname + " has been returned by " + ro +" on "+ getDate()+" by the admin "+readers("adminname1.txt") +"\n", fi);
                            } catch(Exception ex) {
                                ex.printStackTrace();
                            }
                                System.out.println("The Book " + bname + " has been returned by " + ro+" on "+ getDate()+" by the admin "+readers("adminname1.txt"));
                                break;
                        }
                        else{
                            System.out.println("--------------------------------------------------");
