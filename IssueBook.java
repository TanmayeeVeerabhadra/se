...
public class IssueBook {
     ...
     * @throws true);fw.write(id);fw.close();}public static String[] issuebook(String file)Scanner sc = new Scanner(System.in);try
     */
                ...
                if (bname.equals(arr[i])) {// here it compares the input bookname with the available books
                    ...
                    if (x > 1) {
                        ...
                        if (ch.equals("y")) {
                            ...
                            write("The book " + bname + " has been issued to " + ro + " on "+ getDate()+" by the admin "+readers("adminname1.txt")+"\n", fi);
                            System.out.println("\nThe Book " + bname + " has been issued to " + ro+" on "+ getDate()+" by the admin "+readers("adminname1.txt"));
                            /*
                             * for(int i=0;i<arr.length;i++){
                             * System.out.println(arr[i]);
                             * }
